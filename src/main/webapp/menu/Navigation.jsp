		...
		<aside id="leftsidebar" class="sidebar" style="border: 2px solid white;">
			...
			<div class="menu" style="background-color: black; ">
				<ul class="list">
					...
					<li><a href="TypeMovie"> <i class="material-icons" style="color: white;">text_fields</i>
							<span style="color: white;">QUẢN LÝ THỂ LOẠI PHIM</span>
					</a></li>
					<li style="color: white;"><a href="TypeTicket"> <i class="material-icons" style="color: white;">event_seat</i>
							<span style="color: white;">QUẢN LÝ LOẠI VÉ</span>
					</a></li>
					<li><a href="TypeMovie"> <i class="material-icons" style="color: white;">confirmation_number</i>
							<span style="color: white;">QUẢN LÝ BÁN VÉ</span>
					</a></li>
					<li style="color: white;"><a href="statistic"> <i class="material-icons" style="color: white;">bar_chart</i>
